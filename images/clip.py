...
class ImageClipper():
    ...
    def clip_images(self, input_dir, output_dir):
    ...
    def clip_johnnys_image(self):
        self.clip_images(input_dir=self.input_johnnys_dir, output_dir=self.output_johnnys_dir)

    def clip_others_image(self):
        self.clip_images(input_dir=self.input_johnnys_dir, output_dir=self.output_others_dir)